Rails.application.routes.draw do
 ...
 #resources :error_masters
   namespace :api, defaults: {format: 'json'} do
      namespace :v1 do
        post 'rest_machine_create', to: 'machines#rest_create'
        post 'rest_machine_update', to: 'machines#rest_update'
        get 'rest_machine_delete', to: 'machines#rest_delete'

        post 'rest_user_create', to: 'users#rest_create'
        post 'rest_user_update', to: 'users#rest_update'
        get 'rest_user_delete', to: 'users#rest_delete'


        post 'one_sing', to: 'sessions#one_sing'
        post 'machines/api'
        ...
        post 'toradax_test' => 'roles#toradax_test'
         ...
         post 'part_count_data' => 'machines#part_count_data'
         post 'realay' => 'machines#realay'
